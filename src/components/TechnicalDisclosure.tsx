    ...
    <section id="technology" className="min-h-screen bg-black text-white relative py-20 px-6 border-t border-white/10">
      <div className="container mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-8 font-cormorant text-neutral-400 text-base md:text-lg leading-loose">
            <motion.p
                initial={{ opacity: 0 }}
            ...
            >
              {language === "CN" 
                ...
                : "\"Intelligence\" autonomously generates \"Identity\" codes based on algorithmic assessments of the \"Optimal Solution\" for both planetary evolution and the individual. This process is termed \"Digital Alchemy\". Subsequently, using \"ThoughtControl\" technology, specific frequency audio-visual inputs directly intervene in the brain's neural networks, implanting this code directly into the subject's will."
              }
            </motion.p>
            ...
            <motion.div 
               className="p-4 border-l-2 border-red-500 bg-red-900/10 text-red-200 text-xs tracking-wider space-y-2 font-sans"
